...
void compute_d(BigVectorD& d, BigMatrixD& J, BigVectorD& np, int n);
void update_z(BigVectorD& z, BigMatrixD& J, BigVectorD& d, int n, int iq);
void update_r(BigMatrixD&  R, BigVectorD& r, BigVectorD& d, int n, int iq);
bool add_constraint(BigMatrixD&  R, BigMatrixD&  J, BigVectorD& d, int n, int& iq, double& rnorm);
void delete_constraint(BigMatrixD&  R, BigMatrixD&  J, BigVectorI& A, BigVectorD& u, int n, int p, int& iq, int l);

// Utility functions for computing the Cholesky decomposition and solving
// linear systems
void cholesky_decomposition(BigMatrixD& A, int n);
void cholesky_solve(BigMatrixD& L, BigVectorD& x, BigVectorD& b, int n);
void forward_elimination(BigMatrixD& L, BigVectorD& y, BigVectorD& b, int n);
void backward_elimination(BigMatrixD& U, BigVectorD& x, BigVectorD& y, int n);

// Utility functions for computing the scalar product and the euclidean 
// distance between two numbers
double scalar_product(BigVectorD& x, BigVectorD& y, int n);
double distance(double a, double b);

// Utility functions for printing vectors and matrices
void print_matrix(char* name, BigMatrixD& A, int n);
void print_rmatrix(char* name, BigMatrixD& A, int n, int m);
void print_vector(char* name, BigVectorD& v, int n);
                      ...
                      BigVectorD& x)
{
	...
	BigMatrix<double> R(n, MATRIX_DIM);
	BigVector<double> s(m + p);
	BigVector<double> z(n);
	BigVector<double> r(m + p);
	BigVector<double> d(n);
	BigMatrix<double> J(n, MATRIX_DIM);
	BigVector<double> np(n);
	BigVector<double> u(m + p);

	//double x_old[n], u_old[m + p];
	BigVector<double> x_old(n);
	BigVector<double> u_old(m + p);
...
bool add_constraint(BigMatrixD& R, BigMatrixD& J, BigVectorD& d, int n, int& iq, double& R_norm)
{
#ifdef TRACE_SOLVER
