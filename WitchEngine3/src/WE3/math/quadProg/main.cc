...
void test() {
	...
	BigMatrixD G(MATRIX_DIM, MATRIX_DIM);
	BigVectorD g0(MATRIX_DIM);
	BigMatrixD CE(MATRIX_DIM, MATRIX_DIM);
	BigVectorD ce0(MATRIX_DIM);
	BigMatrixD CI(MATRIX_DIM, MATRIX_DIM);
	BigVectorD ci0(MATRIX_DIM);
	BigVectorD x(MATRIX_DIM);
